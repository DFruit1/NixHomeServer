...
Validation gate: see [Operations](./documentation/operations.md#validation-gate) for the canonical `nix flake check --no-build` and `scripts/check-repo.sh` workflow.
