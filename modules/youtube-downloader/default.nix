  ...
  config = lib.mkIf config.nixhomeserver.apps."youtube-downloader".enable (lib.mkMerge [
    {
      ...
      systemd.tmpfiles.rules = [
        "d ${stateRoot} 0750 ${serviceUser} ${serviceGroup} -"
        "d ${stateDir} 0750 ${serviceUser} ${serviceGroup} -"
        "d ${cacheRoot} 0750 ${serviceUser} ${serviceGroup} -"
        "d ${tempDir} 0750 ${serviceUser} ${serviceGroup} -"
      ];
