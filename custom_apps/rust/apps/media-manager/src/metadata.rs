...
pub struct MetadataHealthIssue {
    ...
    /// Files affected by a folder-grouped problem (track order, ...).
    /// Empty for per-item issues. Bounded by the producer.
    #[serde(skip_serializing_if = "Vec::is_empty")]
    pub affected_files: Vec<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub affected_file_count: Option<usize>,
}
