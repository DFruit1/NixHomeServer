...
for mutation_source in "$reconcile_script" custom_apps/shell/homepage/homepage-offline-media-{enroll,remove}.sh.in scripts/helpers/offline-media-disabled-cleanup.sh; do
...
if rg -Fq 'contains("..")' \
    custom_apps/shell/homepage/*.sh.in \
