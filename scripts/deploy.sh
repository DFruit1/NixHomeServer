...
usage() {
  cat <<'EOF'
Usage: scripts/deploy.sh [--target <user@host>] [--build-host <user@host>] [--action test|switch] [--hostname <flake-hostname>] [--debug]

Stage the current repo on the build host and run a remote NixOS rebuild.
